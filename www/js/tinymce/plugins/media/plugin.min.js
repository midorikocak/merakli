tinymce.PluginManager.add("media", function (e, t) {
    ...
    function o() {
        function t(e) {
            var t, i, a, c;
            t = r.find("#width")[0], i = r.find("#height")[0], a = t.value(), c = i.value(), r.find("#constrain")[0].checked() && o && m && a && c && (e.control == t ? (c = Math.round(a / o * c), i.value(c)) : (a = Math.round(c / m * a), t.value(a))), o = a, m = c
        }

        function i() {
            u = n(this.value()), this.parent().parent().fromJSON(u)
        }
        ...
        var r, o, m, u, d = [{
            ...
            label: "Source",
            onchange: function (e) {
                tinymce.each(e.meta, function (e, t) {
                    r.find("#" + t).value(e)
                })
            }
        }];
        e.settings.media_alt_source !== !1 && d.push({
            name: "source2",
            type: "filepicker",
            filetype: "media",
            size: 40,
            label: "Alternative source"
        }), e.settings.media_poster !== !1 && d.push({
            name: "poster",
            type: "filepicker",
            filetype: "image",
            size: 40,
            label: "Poster"
        }), e.settings.media_dimensions !== !1 && d.push({
            type: "container",
            label: "Dimensions",
            layout: "flex",
            align: "center",
        ...
        }), u = s(e.selection.getNode()), o = u.width, m = u.height;
        var h = {
            id: "mcemediasource",
            type: "textbox",
            flex: 1,
        ...
        h[l] = i, r = e.windowManager.open({
            title: "Insert/edit video",
            data: u,
            bodyType: "tabpanel",
            body: [{
                title: "General", type: "form", onShowTab: function () {
                    u = n(this.next().find("#embed").value()), this.fromJSON(u)
                }, items: d
            }, {
                title: "Embed",
                type: "panel",
                ...
                items: [{type: "label", text: "Paste your embed code below:", forId: "mcemediasource"}, h]
            }],
            onSubmit: function () {
                var t, i, r, o;
                for (t = e.dom.select("img[data-mce-object]"), e.insertContent(c(this.toJSON())), i = e.dom.select("img[data-mce-object]"), r = 0; r < t.length; r++)for (o = i.length - 1; o >= 0; o--)t[r] == i[o] && i.splice(o, 1);
                e.selection.select(i[0]), e.nodeChanged()
            }
        })
    }
    ...
    function c(o) {
        var a = "";
        if (!o.source1 && (tinymce.extend(o, n(o.embed)), !o.source1))return "";
        if (o.source2 || (o.source2 = ""), o.poster || (o.poster = ""), o.source1 = e.convertURL(o.source1, "source"), o.source2 = e.convertURL(o.source2, "source"), o.source1mime = i(o.source1), o.source2mime = i(o.source2), o.poster = e.convertURL(o.poster, "poster"), o.flashPlayerUrl = e.convertURL(t + "/moxieplayer.swf", "movie"), tinymce.each(d, function (e) {
                var t, i, r;
    ...
    function m(t) {
        if (e.settings.media_filter_html === !1)return t;
        ...
        return new tinymce.html.SaxParser({
            ...
            start: function (e, t, r) {
                if ("script" != e && "noscript" != e) {
                    for (var o = 0; o < t.length; o++)if (0 === t[o].name.indexOf("on"))return;
                    i.start(e, t, r)
                }
            },
            end: function (e) {
                "script" != e && "noscript" != e && i.end(e)
            }
        }, new tinymce.html.Schema({})).parse(t), i.getContent()
    }
    ...
    }], l = tinymce.Env.ie && tinymce.Env.ie <= 8 ? "onChange" : "onInput";
    e.on("ResolveName", function (e) {
        ...
        tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
            ...
            for (var o, a, c, n, s, m, u, d, l = t.length; l--;)if (a = t[l], a.parent && ("script" != a.name || (d = r(a.attr("src"))))) {
                for (c = new tinymce.html.Node("img", 1), c.shortEnded = !0, d && (d.width && a.attr("width", d.width.toString()), d.height && a.attr("height", d.height.toString())), m = a.attributes, o = m.length; o--;)n = m[o].name, s = m[o].value, "width" !== n && "height" !== n && "style" !== n && (("data" == n || "src" == n) && (s = e.convertURL(s, n)), c.attr("data-mce-p-" + n, s));
            ...
            for (var i, r, o, a, c, n, s, u = e.length; u--;)if (i = e[u], i.parent) {
                for (s = i.attr(t), r = new tinymce.html.Node(s, 1), "audio" != s && "script" != s && r.attr({
                    width: i.attr("width"),
                    height: i.attr("height")
                }), r.attr({style: i.attr("style")}), a = i.attributes, o = a.length; o--;) {
                    var d = a[o].name;
                    0 === d.indexOf("data-mce-p-") && r.attr(d.substr(11), a[o].value)
                }
                "script" == s && r.attr("type", "text/javascript"), c = i.attr("data-mce-html"), c && (n = new tinymce.html.Node("#text", 3), n.raw = !0, n.value = m(unescape(c)), r.append(n)), i.replace(r)
            }
        })
        ...
        var t, i = e.target;
        i.getAttribute("data-mce-object") && (t = i.getAttribute("data-mce-html"), t && (t = unescape(t), i.setAttribute("data-mce-html", escape(u(t, {
            width: e.width,
            height: e.height
        })))))
    }), e.addButton("media", {
