!function (e) {
    e.on("AddEditor", function (e) {
        ...
        t.on("init", function () {
            var n = "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img", i = e.explode(t.settings.font_size_style_values), a = t.schema;
            ...
            }), a.getElementRule("font") || a.addValidElements("font[face|size|color|style]"), e.each(n.split(","), function (e) {
            ...
            var e = [], n = "8pt=1 10pt=2 12pt=3 14pt=4 18pt=5 24pt=6 36pt=7", i = t.settings.fontsize_formats || n;
            return t.$.each(i.split(" "), function (t, n) {
                var i = n, a = n, o = n.split("=");
                o.length > 1 && (i = o[0], a = o[1]), e.push({text: i, value: a})
            }), {
                type: "listbox",
                text: "Font Sizes",
                tooltip: "Font Sizes",
                ...
                onPostRender: function () {
                    ...
                    t.on("NodeChange", function () {
                        var n;
                        n = t.dom.getParent(t.selection.getNode(), "font"), e.value(n ? n.size : "")
                    })
                },
                onclick: function (e) {
            ...
            return i.each(o, function (e, t) {
                ...
                onPostRender: function () {
                    ...
                    t.on("NodeChange", function () {
                        var n;
                        n = t.dom.getParent(t.selection.getNode(), "font"), e.value(n ? n.face : "")
                    })
                },
                onselect: function (e) {
                    e.control.settings.value && t.execCommand("FontName", !1, e.control.settings.value)
                }
            }
        })
    })
