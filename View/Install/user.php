            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="small-9 columns">
                        <input type="text" id="username" name="user[username]" placeholder="i.e mtkocak">
                    </div>
                </div>
                <div class="row">
                    <div class="small-3 columns">
                    ...
                    <div class="small-9 columns">
                        <input type="text" id="email" name="user[email]" placeholder="i.e mtkocak@mtkocak.net">
                    </div>
                </div>
                <div class="row">
                    <div class="small-3 columns">
                    ...
                    <div class="small-9 columns">
                        <input type="password" id="password" name="user[password1]" placeholder="password">
                    </div>
                </div>
                <div class="row">
                    <div class="small-3 columns">
                    ...
                    <div class="small-9 columns">
                        <input type="password" id="password" name="user[password2]" placeholder="password">
                    </div>
                </div>
                <div class="row">
