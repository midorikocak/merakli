        ...
        <form action="<?= LINK_PREFIX ?>/Categories/Add" method="post">
            <div class="row">
                <div class="large-12 columns">
                    <label>Category
                        <input id="title" name="title[0]" type="text" placeholder="Title"/>
                    </label>
                </div>
            </div>
            <div class="row">
                <div class="large-12 columns">
                    <label>Category
                        <input id="title" name="title[1]" type="text" placeholder="Title"/>
                    </label>
                </div>
            </div>
            <div class="row">
                <div class="large-12 columns">
                    <label>Category
                        <input id="title" name="title[2]" type="text" placeholder="Title"/>
                    </label>
                </div>
            </div>
            <div class="row">
                <div class="large-12 columns">
                    <label>Category
                        <input id="title" name="title[3]" type="text" placeholder="Title"/>
                    </label>
                </div>
            </div>
            <div class="row">
