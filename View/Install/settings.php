			...
			<form method="post">
				<div class="row">
					...
					<div class="small-9 columns">
						<input type="text" id="title" name="setting[title]"
							placeholder="i.e Merakli Bilişimci">
					</div>
				</div>
				<div class="row">
					<div class="small-3 columns">
					...
					<div class="small-9 columns">
						<input type="text" id="title" name="setting[description]"
				...
				<div class="row">
					...
					<div class="small-9 columns">
						<input type="text" id="copyright" name="setting[copyright]"
							placeholder="root">
					</div>
				</div>
				<div class="row">
